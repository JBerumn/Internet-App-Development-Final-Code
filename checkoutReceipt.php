            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        $fname = $_POST['fname'];
                        $email = $_POST['email'];
                        $address = $_POST['address'] . ", " . $_POST['address2'] . ", " . $_POST['city'] . ", " . $_POST['country'] . ", " . $_POST['zip'];
                        ...
                        <div class="checkout-faqs wow fadeInUp" id="checkout-faq">
                            <h3>Thank you for your order, <strong><?php echo htmlspecialchars($fname); ?></strong>.</h3>
                            <h3>We will send you an email receipt shortly at the provided email: <strong><?php echo htmlspecialchars($email); ?></strong></h3>
                            <br><br><h3><strong>Delivery Address:</strong> <?php echo htmlspecialchars($address); ?></h3>
                            <h3><strong>Payment Method:</strong> <?php echo htmlspecialchars($payment_method); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="row">
